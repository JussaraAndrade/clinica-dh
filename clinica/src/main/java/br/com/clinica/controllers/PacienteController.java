...
public class PacienteController {
	...
	public Paciente updatePaciente(@PathVariable int idPaciente, @RequestBody Paciente dadosPaciente) throws Exception{
		...
		if(dadosPaciente.getNome() != null) pacienteDB.setNome(dadosPaciente.getNome());
		if(dadosPaciente.getCpf() != null)pacienteDB.setCpf(dadosPaciente.getCpf());
		if(dadosPaciente.getPeso() != null)pacienteDB.setPeso(dadosPaciente.getPeso());
		if(dadosPaciente.getEmail()!= null)pacienteDB.setEmail(dadosPaciente.getEmail());
		if(dadosPaciente.getData_nascimento()!= null)pacienteDB.setData_nascimento(dadosPaciente.getData_nascimento());
		if(dadosPaciente.getTelefone()!= null)pacienteDB.setTelefone(dadosPaciente.getTelefone());
		if(dadosPaciente.getAltura()!= null)pacienteDB.setAltura(dadosPaciente.getAltura());
		if(dadosPaciente.getData_primeira_consulta()!= null)pacienteDB.setData_primeira_consulta(dadosPaciente.getData_primeira_consulta());
		if(dadosPaciente.getEndereco()!= null)pacienteDB.setEndereco(dadosPaciente.getEndereco());
